...
**一个 Minecraft Forge、Fabric、NeoForge 传送指令模组。**
...
- **传送至墓碑/遗体**：可传送至上一次死亡位置或附近墓碑/遗体，支持与多种墓碑模组联动；手持讣告类物品可传送至该记录位置。
- **传送点记录界面**：客户端提供传送点记录界面，可查看私人传送点、驿站等并快速传送。
- **模组联动**：与墓碑类模组（墓碑、简单坟墓、Corail 的墓碑、遗体）、地图类模组（Xaero 小地图、旅行地图、FTB 区块）、ApricityUI
  等联动，扩展传送与地图体验。
...
- **版本迁移**：将加载了 Minecraft 1.12.2 版本的该模组的存档升级到高版本 Minecraft 时，可能会因为数据不兼容而出现各种问题。
