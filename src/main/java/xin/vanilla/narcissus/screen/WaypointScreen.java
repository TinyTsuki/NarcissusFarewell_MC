...
public class WaypointScreen extends BaniraScreen {
    ...
    private void drawDragTooltip(MatrixStack stack, BaniraColorConfig theme, int mouseX, int mouseY) {
    ...
    private static void drawDragHandle(MatrixStack stack, int x, int y, int color) {
    ...
    private void drawDragPreview(MatrixStack stack, int listX, int rowWidth,
