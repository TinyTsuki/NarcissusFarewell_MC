...
public class AccessListScreen extends BaniraScreen {
    ...
    private void drawAccessTabs(MatrixStack stack, int mouseX, int mouseY) {
    ...
    private void drawAccessTooltip(MatrixStack stack, BaniraColorConfig theme, String uuid,
