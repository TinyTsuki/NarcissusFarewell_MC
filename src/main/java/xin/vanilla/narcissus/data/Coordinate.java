...
public class Coordinate implements Serializable, Cloneable {
    ...
    public static Coordinate random(ServerPlayerEntity player, int range, DimensionType dimension) {
        ...
        double y = getRandomWithWeight(NarcissusUtils.getWorldMinY(world), NarcissusUtils.getWorldMaxY(world), (int) player.y, 0.75);
    ...
    public static Coordinate readFromNBT(CompoundNBT tag) {
        ...
        coordinate.dimension = DimensionType.getByName(NarcissusFarewell.parseResource(tag.getString("dimension")));
        return coordinate;
    }
    ...
    public String getDimensionResourceId() {
        return dimension.getRegistryName().toString();
    }
}
