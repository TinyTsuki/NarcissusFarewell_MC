...
public class TpNoNotice implements IMessage {
    ...
    public static class Handler implements IMessageHandler<TpNoNotice, IMessage> {
        @Override
        public IMessage onMessage(TpNoNotice packet, MessageContext ctx) {
            // 获取网络事件上下文并排队执行工作
