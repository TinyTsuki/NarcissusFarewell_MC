...
public class VirtualPermissionManager {
     ...
     * 添加权限（合并原有权限）
     */
    public static void addVirtualPermission(PlayerEntity player, ECommandType... types) {
     ...
     * 设置权限（覆盖原有权限）
     */
    public static void setVirtualPermission(PlayerEntity player, ECommandType... types) {
     ...
     * 删除权限
     */
    public static void delVirtualPermission(PlayerEntity player, ECommandType... types) {
     ...
     * 获取当前权限列表
     */
    public static Set<ECommandType> getVirtualPermission(PlayerEntity player) {
