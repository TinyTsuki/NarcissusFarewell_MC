...
public class Component implements Cloneable, Serializable {
    ...
    public static net.minecraft.network.chat.Component rewriteColor(net.minecraft.network.chat.Component component) {
        if (component instanceof MutableComponent) {
            ...
            if (color != null && color.serialize().startsWith("#")) {
                DataResult<TextColor> result = TextColor.parseColor(ColorUtils.argbToMinecraftColor(ColorUtils.parseArgb(color.serialize())).name().toLowerCase());
    ...
    public static Component deserialize(JsonObject jsonObject) {
        ...
        if (jsonObject.has("clickEvent")) {
            ClickEvent.CODEC.decode(JsonOps.INSTANCE, JsonUtils.getJsonObject(jsonObject, "clickEvent")).result().ifPresent(value -> result.clickEvent(value.getFirst()));
        }
        if (jsonObject.has("hoverEvent")) {
            HoverEvent.CODEC.decode(JsonOps.INSTANCE, JsonUtils.getJsonObject(jsonObject, "hoverEvent")).result().ifPresent(value -> result.hoverEvent(value.getFirst()));
        }
    ...
    public static JsonObject serialize(Component component) {
        ...
        if (component.clickEvent() != null) {
            ClickEvent.CODEC.encodeStart(JsonOps.INSTANCE, component.clickEvent()).result().ifPresent(value -> JsonUtils.setJsonElement(result, "clickEvent", value));
        }
        if (component.hoverEvent() != null) {
            HoverEvent.CODEC.encodeStart(JsonOps.INSTANCE, component.hoverEvent()).result().ifPresent(value -> JsonUtils.setJsonElement(result, "hoverEvent", value));
        }
