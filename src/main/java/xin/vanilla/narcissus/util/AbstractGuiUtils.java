...
public final class AbstractGuiUtils {
     ...
     * 绘制多边形边框
     */
    private static void drawPolygonBorder(MatrixStack stack, ShapeDrawArgs.PolygonParams polygon, int color) {
    ...
    public static void drawItemTooltip(MatrixStack stack, ItemStack itemStack, double x, double y) {
