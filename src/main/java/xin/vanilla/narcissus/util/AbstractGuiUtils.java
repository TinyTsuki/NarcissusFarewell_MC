...
public final class AbstractGuiUtils {
    ...
    private static Matrix4f getPoseMatrix4f(Matrix3x2fc pose) {
        float[] arr = new float[16];
        pose.get4x4(arr);
        return new Matrix4f().set(arr);
    }
    ...
    private static final RenderPipeline GUI_RENDER_TYPE = RenderPipelines.GUI_TEXTURED;

    public static void blit(GuiGraphics graphics, int x0, int y0, int z, int destWidth, int destHeight, TextureAtlasSprite sprite) {
        graphics.blitSprite(GUI_RENDER_TYPE, sprite, x0, y0, z, destWidth, destHeight);
    }
    ...
    public static void blit(GuiGraphics graphics, net.minecraft.resources.Identifier location, int x0, int y0, int z, double u0, double v0, int width, int height, int textureHeight, int textureWidth) {
        graphics.blit(GUI_RENDER_TYPE, location, x0, y0, (float) u0, (float) v0, width, height, textureWidth, textureHeight);
    }

    public static void blitBlend(GuiGraphics graphics, net.minecraft.resources.Identifier location, int x0, int y0, int z, double u0, double v0, int width, int height, int textureHeight, int textureWidth) {
        blitByBlend(() ->
                graphics.blit(GUI_RENDER_TYPE, location, x0, y0, (float) u0, (float) v0, width, height, textureWidth, textureHeight)
        );
    }

    public static void blit(GuiGraphics graphics, net.minecraft.resources.Identifier location, int x0, int y0, int destWidth, int destHeight, double u0, double v0, int srcWidth, int srcHeight, int textureWidth, int textureHeight) {
        graphics.blit(GUI_RENDER_TYPE, location, x0, y0, (float) u0, (float) v0, destWidth, destHeight, srcWidth, srcHeight, textureWidth, textureHeight);
    }

    public static void blitBlend(GuiGraphics graphics, net.minecraft.resources.Identifier location, int x0, int y0, int destWidth, int destHeight, double u0, double v0, int srcWidth, int srcHeight, int textureWidth, int textureHeight) {
        blitByBlend(() ->
                graphics.blit(GUI_RENDER_TYPE, location, x0, y0, (float) u0, (float) v0, destWidth, destHeight, srcWidth, srcHeight, textureWidth, textureHeight)
        );
    }

    public static void blit(GuiGraphics graphics, net.minecraft.resources.Identifier location, int x0, int y0, double u0, double v0, int destWidth, int destHeight, int textureWidth, int textureHeight) {
        graphics.blit(GUI_RENDER_TYPE, location, x0, y0, (float) u0, (float) v0, destWidth, destHeight, textureWidth, textureHeight);
    }

    public static void blitBlend(GuiGraphics graphics, net.minecraft.resources.Identifier location, int x0, int y0, double u0, double v0, int destWidth, int destHeight, int textureWidth, int textureHeight) {
        blitByBlend(() ->
                graphics.blit(GUI_RENDER_TYPE, location, x0, y0, (float) u0, (float) v0, destWidth, destHeight, textureWidth, textureHeight)
        );
    }
    ...
    public static void renderByTransform(TransformArgs args, Consumer<TransformDrawArgs> drawFunc) {
        ...
        drawArgs.x(0).y(0).width(args.width()).height(args.height()).alpha(args.alpha());
     ...
     * @param argbs 文本颜色
     */
    public static void drawMultilineText(FontDrawArgs args, int... argbs) {
     ...
     * @param args 绘制参数
     */
    public static KeyValue<Integer, Integer> calculateLimitedTextSize(FontDrawArgs args) {
        Text text = args.text();
     ...
     */
    private static String ellipsisString(FontDrawArgs args, String ellipsis, Font font, int ellipsisWidth, int availableWidth, String line) {
        if (availableWidth <= 0) {
            return line;
        }
     ...
     */
    public static void drawLimitedText(FontDrawArgs args) {
        Text text = args.text();
    ...
    public static void drawEffectIcon(GuiGraphics graphics, Font font, MobEffectInstance effectInstance, int x, int y, int width, int height, boolean showText) {
        net.minecraft.resources.Identifier effectIcon = TextureUtils.getEffectTexture(effectInstance);
        if (effectIcon != null) {
    ...
    public static void drawLine(GuiGraphics graphics, float x1, float y1, float x2, float y2, float lineWidth, int color) {
        ...
        Matrix4f m4 = getPoseMatrix4f(graphics.pose());
    ...
    public static int withAlpha(int argb, double alpha) {
        int a = Math.min(255, Math.max(0, (int) alpha)) & 0xFF;
    ...
    public static void drawItemTooltip(GuiGraphics graphics, ItemStack itemgraphics, double x, double y) {
        boolean advanced = Minecraft.getInstance().hasShiftDown();
