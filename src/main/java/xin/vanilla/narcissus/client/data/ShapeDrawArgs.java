...
public class ShapeDrawArgs {
     ...
     * 创建矩形绘制参数
     */
    public static ShapeDrawArgs rect(GuiGraphics graphics, float x, float y, float width, float height, int color) {
     ...
     * 创建圆形绘制参数
     */
    public static ShapeDrawArgs circle(GuiGraphics graphics, float centerX, float centerY, float radius, int color) {
        return new ShapeDrawArgs()
                .graphics(graphics)
                .color(color)
     ...
     * 创建椭圆绘制参数
     */
    public static ShapeDrawArgs ellipse(GuiGraphics graphics, float centerX, float centerY, float radiusX, float radiusY, int color) {
        return new ShapeDrawArgs()
                .graphics(graphics)
                .color(color)
     ...
     * 创建扇形绘制参数
     */
    public static ShapeDrawArgs sector(GuiGraphics graphics, float centerX, float centerY, float radius, double startAngle, double endAngle, int color) {
        return new ShapeDrawArgs()
                .graphics(graphics)
                .color(color)
     ...
     * 使用弧度创建扇形绘制参数
     */
    public static ShapeDrawArgs sectorRad(GuiGraphics graphics, float centerX, float centerY, float radius, double startAngle, double endAngle, int color) {
        return new ShapeDrawArgs()
                .graphics(graphics)
                .color(color)
                .type(ShapeType.SECTOR)
     ...
     * 创建扇环绘制参数
     */
    public static ShapeDrawArgs sectorRing(GuiGraphics graphics, float centerX, float centerY, float outerRadius, float innerRadius, double startAngle, double endAngle, int color) {
        return new ShapeDrawArgs()
                .graphics(graphics)
                .color(color)
     ...
     * 创建扇环绘制参数（使用弧度）
     */
    public static ShapeDrawArgs sectorRingRad(GuiGraphics graphics, float centerX, float centerY, float outerRadius, double startAngle, double endAngle, int color) {
        return new ShapeDrawArgs()
                .graphics(graphics)
                .color(color)
                .type(ShapeType.SECTOR_RING)
     ...
     * 创建多边形绘制参数
     */
    public static ShapeDrawArgs polygon(GuiGraphics graphics, float centerX, float centerY, float radius, int sides, int color) {
        return new ShapeDrawArgs()
                .graphics(graphics)
                .color(color)
