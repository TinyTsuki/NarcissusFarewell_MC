...
import xin.vanilla.narcissus.util.TextureUtils;
...
public class Texture {
    ...
    private Texture(@Nonnull net.minecraft.resources.Identifier location) {
    ...
    private Texture(net.minecraft.resources.Identifier location, int uvWidth, int uvHeight) {
        this.location = location;
    ...
    public static Texture empty() {
        return new Texture(MissingTextureAtlasSprite.getLocation());
    }

    public static Texture of(@Nonnull net.minecraft.resources.Identifier location) {
        return new Texture(location);
    }

    public static Texture of(@Nonnull net.minecraft.resources.Identifier location, int uvWidth, int uvHeight) {
        return new Texture(location, uvWidth, uvHeight);
    }

    public static Texture of(@Nonnull net.minecraft.resources.Identifier location, Texture texture) {
