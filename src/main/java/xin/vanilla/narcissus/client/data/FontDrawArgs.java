...
import xin.vanilla.narcissus.util.AbstractGuiUtils;
...
public class FontDrawArgs implements Cloneable {
    ...
    public static FontDrawArgs of(String text, GuiGraphics graphics) {
        return new FontDrawArgs(Text.literal(text).graphics(graphics));
    }

    public static FontDrawArgs of(String text, GuiGraphics graphics, Font font) {
        return new FontDrawArgs(Text.literal(text).graphics(graphics).font(font));
    }
    ...
    public static FontDrawArgs ofPopo(String text, GuiGraphics graphics) {
        return new FontDrawArgs(Text.literal(text).graphics(graphics)).defaultPopoStyle();
    }

    public static FontDrawArgs ofPopo(String text, GuiGraphics graphics, Font font) {
        return new FontDrawArgs(Text.literal(text).graphics(graphics).font(font)).defaultPopoStyle();
    }
