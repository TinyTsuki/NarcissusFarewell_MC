...
public final class TpHereCommand {
    ...
    private static int execute(CommandContext<CommandSource> context) throws CommandSyntaxException {
        ...
        if (!ignore) {
            ...
            NarcissusUtils.sendMessage(target, NarcissusLang.transLangAuto(NarcissusLang.getPlayerLanguage(target), "tp_here_request_received",
                    player.getDisplayName().getString(), NarcissusLang.transLangAuto(NarcissusLang.getPlayerLanguage(target), request.isSafe() ? "tp_here_safe" : "tp_here_unsafe"), yesButton, noButton));
        }
        ...
        NarcissusUtils.sendMessage(player, NarcissusLang.transLangAuto(NarcissusLang.getPlayerLanguage(player), "tp_here_request_sent", target.getDisplayName().getString(), cancelButton));
        if (autoAccept) {
