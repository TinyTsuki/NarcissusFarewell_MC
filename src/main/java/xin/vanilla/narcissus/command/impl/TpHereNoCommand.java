...
public final class TpHereNoCommand {
    ...
    private static int execute(CommandContext<CommandSource> context) throws CommandSyntaxException {
        ...
        MessageUtils.sendNotification(request.getRequester(), NarcissusComponent.get().transAuto("tp_here_rejected", request.getTarget().getDisplayName().getString()), NarcissusNotificationTypes.TELEPORT_REQUEST);
        return 1;
    }
