...
public final class TpHereNoCommand {
    ...
    private static int execute(CommandContext<CommandSource> context) throws CommandSyntaxException {
        ...
        NarcissusNotificationSend.send(request.getRequester(), NarcissusComponent.get().transAuto("tp_here_rejected", request.getTarget().getDisplayName().getString()), NarcissusNotificationTypes.TELEPORT_REQUEST);
        return 1;
    }
