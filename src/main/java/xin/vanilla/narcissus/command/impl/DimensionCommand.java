...
public final class DimensionCommand {
    ...
    private static int execute(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        dim.color(EnumMCColor.GREEN.getColor())
                .clickEvent(new ClickEvent.CopyToClipboard(dimString))
                .hoverEvent(new HoverEvent.ShowText(Component.trans(NarcissusUtils.getPlayerLanguage(player), EnumI18nType.FORMAT, "chat_copy_click").toTextComponent()));
