...
public final class UuidCommand {
    ...
    private static int execute(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        uuid.color(EnumMCColor.GREEN.getColor())
                .clickEvent(new ClickEvent.CopyToClipboard(target.getStringUUID()))
                .hoverEvent(new HoverEvent.ShowText(Component.trans(language, EnumI18nType.FORMAT, "chat_copy_click").toTextComponent()));
