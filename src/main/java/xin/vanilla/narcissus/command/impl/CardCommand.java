        ...
        return Commands.literal(CommonConfig.COMMAND_CARD.get())
                ...
                .then(Commands.argument("type", StringArgumentType.word())
                        ...
                        .suggests((context, builder) -> {
                            ...
                            builder.suggest("get", Component.trans(lang, xin.vanilla.narcissus.enums.EnumI18nType.FORMAT, "suggest_card_get").toTextComponent());
                            builder.suggest("add", Component.trans(lang, xin.vanilla.narcissus.enums.EnumI18nType.FORMAT, "suggest_card_add").toTextComponent());
                            builder.suggest("set", Component.trans(lang, xin.vanilla.narcissus.enums.EnumI18nType.FORMAT, "suggest_card_set").toTextComponent());
