    ...
    private static int execute(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (data.getStageCoordinate().isEmpty()) {
            ...
            for (Map.Entry<String, List<KeyValue<String, Coordinate>>> entry : map.entrySet()) {
                ...
                dimension.clickEvent(new ClickEvent.CopyToClipboard(entry.getKey()));
                dimension.hoverEvent(new HoverEvent.ShowText(Component.literal(entry.getKey()).toTextComponent()));
                ...
                for (KeyValue<String, Coordinate> coordinates : entry.getValue()) {
                    ...
                    name.clickEvent(new ClickEvent.CopyToClipboard(name_hover.toString(true)));
                    name.hoverEvent(new HoverEvent.ShowText(name_hover.toChatComponent()));
