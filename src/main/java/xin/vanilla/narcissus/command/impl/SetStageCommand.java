...
public final class SetStageCommand {
    ...
    private static void sendStageMessage(CommandSource source, Component message, boolean success) {
        if (source.getEntity() instanceof ServerPlayerEntity) {
            MessageUtils.sendNotification((ServerPlayerEntity) source.getEntity(), message);
        } else {
