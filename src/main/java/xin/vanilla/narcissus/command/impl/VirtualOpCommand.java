        ...
        if (source.getEntity() == null || source.getEntity() instanceof ServerPlayer) {
            ...
            for (ServerPlayer target : targetList) {
                ...
                if (source.getEntity() != null && source.getEntity() instanceof ServerPlayer) {
                    ...
                    source.sendSuccess(() -> Component.trans(finalLanguage, EnumI18nType.FORMAT, "player_virtual_op", target.getDisplayName().getString(), permissions).toChatComponent(), true);
                }
