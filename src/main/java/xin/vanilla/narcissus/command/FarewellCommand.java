...
public class FarewellCommand {
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        ...
        Command<CommandSource> tpHomeCommand = context -> {
            ...
            try {
                RegistryKey<World> targetDimension = RegistryKey.create(Registry.DIMENSION_REGISTRY, NarcissusFarewell.parseResource(StringArgumentType.getString(context, "dimension")));
        ...
        Command<CommandSource> delHomeCommand = context -> {
            ...
            String dimension;
            try {
                RegistryKey<World> targetLevel = RegistryKey.create(Registry.DIMENSION_REGISTRY, NarcissusFarewell.parseResource(StringArgumentType.getString(context, "dimension")));
        ...
        Command<CommandSource> flyCommand = context -> {
            notifyHelp(context);
            CommandSource source = context.getSource();
            // 传送功能前置校验
        ...
        LiteralArgumentBuilder<CommandSource> fly = // region fly
