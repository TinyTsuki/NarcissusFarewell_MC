...
public class FarewellCommand {
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        ...
        SuggestionProvider<CommandSource> dimensionSuggestions = (context, builder) -> {
            for (ServerWorld level : context.getSource().getServer().getAllLevels()) {
                builder.suggest(level.dimension.getType().getRegistryName().toString());
            }
            return builder.buildFuture();
        };
        ...
        Command<CommandSource> tpCoordinateCommand = context -> {
            ...
            try {
                Vec3d pos = Vec3Argument.getCoordinates(context, "coordinate").getPosition(context.getSource());
                ...
                target = NarcissusFarewell.getTeleportRequest().values().stream()
                        ...
                        .filter(request -> {
                            ...
                            return NarcissusUtils.isTeleportTypeAcrossDimensionEnabled(player, EnumTeleportType.TP_ASK)
                                    || entity != null && entity.level.dimension.getType() == player.getLevel().dimension.getType();
                        })
        ...
        Command<CommandSource> tpSpawnCommand = context -> {
            ...
            BlockPos respawnPosition = target.getBedLocation(player.dimension);
            coordinate.setDimension(target.dimension);
            if (respawnPosition == null) {
                respawnPosition = target.getLevel().getSharedSpawnPos();
                coordinate.setDimension(target.level.getDimension().getType());
            }
            if (respawnPosition == null) {
                respawnPosition = target.getServer().getLevel(DimensionType.OVERWORLD).getSharedSpawnPos();
        ...
        Command<CommandSource> tpWorldSpawnCommand = context -> {
            ...
            if (respawnPosition == null) {
                respawnPosition = player.getServer().getLevel(DimensionType.OVERWORLD).getSharedSpawnPos();
                coordinate.setDimension(DimensionType.OVERWORLD);
            }
            coordinate.fromBlockPos(respawnPosition);
            coordinate.setSafe("safe".equalsIgnoreCase(getStringDefault(context, "safe", "safe")));
        ...
        Command<CommandSource> tpHomeCommand = context -> {
            ...
            try {
                DimensionType targetDimension = DimensionType.getByName(NarcissusFarewell.parseResource(StringArgumentType.getString(context, "dimension")));
            ...
            if (coordinate == null) {
                if (targetLevel == null && name == null) {
                    ...
                    NarcissusUtils.sendTranslatableMessage(player, I18nUtils.getKey(EnumI18nType.MESSAGE, "home_not_found_in_dimension"), targetLevel.getRegistryName().toString());
                    ...
                    NarcissusUtils.sendTranslatableMessage(player, I18nUtils.getKey(EnumI18nType.MESSAGE, "home_not_found_with_name_in_dimension"), targetLevel.getRegistryName().toString(), name);
                }
                return 0;
            }
            try {
        ...
        Command<CommandSource> setHomeCommand = context -> {
            ...
            Coordinate coordinate = new Coordinate(player);
            KeyValue<String, String> key = new KeyValue<>(player.getLevel().dimension.getType().getRegistryName().toString(), name);
            ...
            if (defaultHome) {
                if (data.getDefaultHome().containsKey(player.getLevel().dimension.getType().getRegistryName().toString())) {
                    NarcissusUtils.sendTranslatableMessage(player, I18nUtils.getKey(EnumI18nType.MESSAGE, "home_default_remove"), data.getDefaultHome(player.getLevel().dimension.getType().getRegistryName().toString()).getValue());
                }
                data.addDefaultHome(player.getLevel().dimension.getType().getRegistryName().toString(), name);
        ...
        Command<CommandSource> delHomeCommand = context -> {
            ...
            String dimension;
            try {
                DimensionType targetLevel = DimensionType.getByName(NarcissusFarewell.parseResource(StringArgumentType.getString(context, "dimension")));
                dimension = targetLevel.getRegistryName().toString();
            } catch (IllegalArgumentException ignored) {
        ...
        Command<CommandSource> tpStageCommand = context -> {
            ...
            if (dimension == null) {
                ...
                if (coordinateSize == 1) {
                    ...
                    coordinate = stageData.getCoordinate(player.getLevel().dimension.getType().getRegistryName().toString(), name);
                }
                if (coordinate == null) {
        ...
        Command<CommandSource> tpBackCommand = context -> {
            ...
            DimensionType targetLevel = null;
            try {
                type = EnumTeleportType.valueOf(StringArgumentType.getString(context, "type"));
            } catch (IllegalArgumentException ignored) {
            }
            try {
                DimensionType targetDimension = DimensionType.getByName(NarcissusFarewell.parseResource(StringArgumentType.getString(context, "dimension")));
        ...
        Command<CommandSource> addWhiteListCommand = context -> {
        ...
        Command<CommandSource> removeWhiteListCommand = context -> {
            Collection<ServerPlayerEntity> players = EntityArgument.getPlayers(context, "players");
            if (CollectionUtils.isNullOrEmpty(players)) {
                return 0;
            }
        ...
        LiteralArgumentBuilder<CommandSource> dim =  // region dim
                Commands.literal(CommonConfig.COMMAND_DIMENSION.get())
                        .executes(dimCommand);// endregion dim
        LiteralArgumentBuilder<CommandSource> uuid = // region uuid
        ...
        LiteralArgumentBuilder<CommandSource> share = // region share
        ...
        LiteralArgumentBuilder<CommandSource> feed = // region feed
        ...
        LiteralArgumentBuilder<CommandSource> tpx = // region tpx
        ...
        LiteralArgumentBuilder<CommandSource> tpst = // region tpst
        ...
        LiteralArgumentBuilder<CommandSource> tpa = // region tpa
        ...
        LiteralArgumentBuilder<CommandSource> tpaYes = // region tpaYes
        ...
        LiteralArgumentBuilder<CommandSource> tpaNo = // region tpaNo
        ...
        LiteralArgumentBuilder<CommandSource> tpaCancel = // region tpaCancel
        ...
        LiteralArgumentBuilder<CommandSource> tph = // region tph
        ...
        LiteralArgumentBuilder<CommandSource> tphYes = // region tphYes
        ...
        LiteralArgumentBuilder<CommandSource> tphNo = // region tphNo
        ...
        LiteralArgumentBuilder<CommandSource> tphCancel = // region tphCancel
        ...
        LiteralArgumentBuilder<CommandSource> tpRandom = // region tpRandom
        ...
        LiteralArgumentBuilder<CommandSource> tpSpawn = // region tpSpawn
        ...
        LiteralArgumentBuilder<CommandSource> tpWorldSpawn = // region tpWorldSpawn
        ...
        LiteralArgumentBuilder<CommandSource> tpTop = // region tpTop
        ...
        LiteralArgumentBuilder<CommandSource> tpBottom = // region tpBottom
        ...
        LiteralArgumentBuilder<CommandSource> tpUp = // region tpUp
        ...
        LiteralArgumentBuilder<CommandSource> tpDown = // region tpDown
        ...
        LiteralArgumentBuilder<CommandSource> tpView = // region tpView
        ...
        LiteralArgumentBuilder<CommandSource> tpHome = // region tpHome
        ...
        LiteralArgumentBuilder<CommandSource> setHome = // region setHome
        ...
        LiteralArgumentBuilder<CommandSource> delHome = // region delHome
        ...
        LiteralArgumentBuilder<CommandSource> getHome = // region getHome
        ...
        LiteralArgumentBuilder<CommandSource> tpStage = // region tpStage
        ...
        LiteralArgumentBuilder<CommandSource> setStage = // region setStage
        ...
        LiteralArgumentBuilder<CommandSource> delStage = // region delStage
        ...
        LiteralArgumentBuilder<CommandSource> getStage = // region getStage
        ...
        LiteralArgumentBuilder<CommandSource> tpBack = // region tpBack
        ...
        LiteralArgumentBuilder<CommandSource> black = // region black
        ...
        LiteralArgumentBuilder<CommandSource> white = // region white
     ...
     */
    private static String getRequestId(CommandContext<CommandSource> context, EnumTeleportType teleportType, final boolean isTarget) {
        String result = null;
        try {
            ServerPlayerEntity player = context.getSource().getPlayerOrException();
            try { // 指定玩家
     ...
     * @param isTarget     是否根据接收方查找
     */
    private static SuggestionProvider<CommandSource> buildReqIndexSuggestions(EnumTeleportType teleportType, final boolean isTarget) {
     ...
     */
    private static boolean checkTeleportPre(CommandSource source, EnumCommandType teleportType) {
        // 判断是否开启传送功能
    ...
    private static boolean checkTeleportPost(TeleportRequest request, boolean submit) {
        boolean result;
        // 判断跨维度传送
        result = NarcissusUtils.isTeleportAcrossDimensionEnabled(request.getRequester(), request.getTarget().getLevel().dimension.getType(), request.getTeleportType());
        // 判断是否有传送代价
     ...
     * @return true 表示校验失败，不应该执行传送
     */
    private static boolean checkTeleportPost(ServerPlayerEntity player, Coordinate target, EnumTeleportType type) {
     ...
     * @return true 表示校验失败，不应该执行传送
     */
    private static boolean checkTeleportPost(ServerPlayerEntity player, Coordinate target, EnumTeleportType type, boolean submit) {
        boolean result;
        // 判断跨维度传送
    ...
    private static Component getWhiteListMessage(ServerPlayerEntity player, PlayerAccess access) {
        Component msg;
