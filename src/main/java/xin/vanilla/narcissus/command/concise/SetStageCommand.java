...
public class SetStageCommand extends CommandBase {

    @Override
    @NonNull
    public String getName() {
        return ServerConfig.COMMAND_SET_STAGE;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.SET_STAGE);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean checkPermission(MinecraftServer server, ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.SET_STAGE);
    }
}
