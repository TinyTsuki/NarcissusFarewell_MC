...
public class DelHomeCommand extends CommandBase {
    ...
    public String getCommandName() {
        return ServerConfig.COMMAND_DEL_HOME;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.DEL_HOME);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean canCommandSenderUseCommand(ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.DEL_HOME);
    }
}
