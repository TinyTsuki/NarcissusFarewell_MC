...
public class AskYesCommand extends CommandBase {

    @Override
    @NonNull
    public String getCommandName() {
        return ServerConfig.COMMAND_TP_ASK_YES;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.TP_ASK_YES);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean canCommandSenderUseCommand(ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.TP_ASK_YES);
    }
}
