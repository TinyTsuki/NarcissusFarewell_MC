...
public class GetHomeCommand extends CommandBase {
    ...
    public String getCommandName() {
        return ServerConfig.COMMAND_GET_HOME;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.GET_HOME);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean canCommandSenderUseCommand(ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.GET_HOME);
    }
}
