...
public class HereCancelCommand extends CommandBase {

    @Override
    @NonNull
    public String getCommandName() {
        return ServerConfig.COMMAND_TP_HERE_CANCEL;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.TP_HERE_CANCEL);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean canCommandSenderUseCommand(ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.TP_HERE_CANCEL);
    }
}
