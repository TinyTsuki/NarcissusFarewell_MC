...
public class VirtualOpCommand extends CommandBase {

    @Override
    @NonNull
    public String getCommandName() {
        return ServerConfig.COMMAND_VIRTUAL_OP;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.VIRTUAL_OP);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean canCommandSenderUseCommand(ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.VIRTUAL_OP);
    }
}
