...
public class HereNoCommand extends CommandBase {

    @Override
    @NonNull
    public String getName() {
        return ServerConfig.COMMAND_TP_HERE_NO;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.TP_HERE_NO);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean checkPermission(MinecraftServer server, ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.TP_HERE_NO);
    }
}
