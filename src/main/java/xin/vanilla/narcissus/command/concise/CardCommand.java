...
public class CardCommand extends CommandBase {
    ...
    public String getCommandName() {
        return ServerConfig.COMMAND_CARD;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.CARD);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean canCommandSenderUseCommand(ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.CARD);
    }
}
