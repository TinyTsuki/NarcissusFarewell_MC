...
public class LanguageCommand extends CommandBase {
    ...
    public String getCommandName() {
        return ServerConfig.COMMAND_LANGUAGE;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.LANGUAGE);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean canCommandSenderUseCommand(ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.LANGUAGE);
    }
}
