...
public class GetStageCommand extends CommandBase {

    @Override
    @NonNull
    public String getName() {
        return ServerConfig.COMMAND_GET_STAGE;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.GET_STAGE);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean checkPermission(MinecraftServer server, ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.GET_STAGE);
    }
}
