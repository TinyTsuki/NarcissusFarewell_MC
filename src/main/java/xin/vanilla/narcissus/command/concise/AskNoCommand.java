...
public class AskNoCommand extends CommandBase {

    @Override
    @NonNull
    public String getName() {
        return ServerConfig.COMMAND_TP_ASK_NO;
    }
    ...
    public int getRequiredPermissionLevel() {
        return NarcissusUtils.getCommandPermissionLevel(ECommandType.TP_ASK_NO);
    }

    @Override
    @ParametersAreNonnullByDefault
    public boolean checkPermission(MinecraftServer server, ICommandSender sender) {
        return NarcissusUtils.hasCommandPermission(sender, ECommandType.TP_ASK_NO);
    }
}
