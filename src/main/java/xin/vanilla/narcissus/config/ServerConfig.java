    ...
    private static void init(boolean write) {
        ...
        // 定义指令权限
        {

            {
                ...
                permissionVirtualOp.setComment(permissionSetCard.getComment() + " [range: " + permissionSetCard.getMinValue() + " ~ " + permissionVirtualOp.getMaxValue() + ", default: " + permissionVirtualOp.getDefault() + "]");
