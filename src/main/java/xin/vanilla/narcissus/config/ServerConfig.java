...
public class ServerConfig {
    ...
    private static void init(boolean write) {
        ...
        // 定义服务器基础设置
        {
            ...
            tpWithFollowerRange.comment = (tpWithFollowerRange.comment + " [range: " + tpWithFollowerRange.getMinValue() + " ~ " + tpWithFollowerRange.getMaxValue() + ", default: " + tpWithFollowerRange.getDefault() + "]");
            ...
            helpInfoNumPerPage.comment = helpInfoNumPerPage.comment + " [range: " + helpInfoNumPerPage.getMinValue() + " ~ " + helpInfoNumPerPage.getMaxValue() + ", default: " + helpInfoNumPerPage.getDefault() + "]";
    ...
    public static void resetConfig() {
        ...
        UNSAFE_BLOCKS = new String[]{
                "minecraft:lava",
                "minecraft:fire",
                "minecraft:cactus",
        };
        SUFFOCATING_BLOCKS = new String[]{
                "minecraft:lava",
                "minecraft:water",
        };
        SETBLOCK_WHEN_SAFE_NOT_FOUND = (false);
        GETBLOCK_FROM_INVENTORY = (true);
        SAFE_BLOCKS = new String[]{
                "minecraft:dirt",
                "minecraft:cobblestone",
        };
        SAFE_CHUNK_RANGE = (1);
